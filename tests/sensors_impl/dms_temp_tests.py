...
# Ensure real numpy is loaded before any other test file's stub can interfere.
# Remove any mock that may have been placed by a previously-loaded test module.
